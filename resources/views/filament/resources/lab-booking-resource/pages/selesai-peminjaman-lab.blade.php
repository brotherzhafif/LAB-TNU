<x-filament-panels::page>
    <form action="{{ route('lab-booking.selesai-upload', ['record' => $this->booking->id]) }}" method="POST"
        ...
        <x-filament::section>
            <div>
                ...
                <label id="upload-label"
                    class="flex flex-col items-center px-6 py-8 bg-white dark:bg-gray-800 text-primary-600 rounded-lg shadow-lg tracking-wide uppercase border-2 border-primary-400 cursor-pointer hover:bg-primary-50 dark:hover:bg-primary-900 transition"
